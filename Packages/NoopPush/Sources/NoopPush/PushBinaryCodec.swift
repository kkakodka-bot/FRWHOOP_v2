...
public enum PushBinaryCodec {
    ...
    public static func pack(table: PushBinaryTable, rows: [PushBinaryRow], ppgIdentityV2: Bool = false) throws -> Data {
    ...
    public static func packedRowSize(_ row: PushBinaryRow, ppgIdentityV2: Bool = false) throws -> Int {
        switch row {
