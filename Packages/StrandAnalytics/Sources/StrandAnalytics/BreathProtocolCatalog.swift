...
"""
    ...
    private static let ansGuided: [BreathProtocol] = [
        ...
        BreathProtocol(
            ...
            edu: "Holotropic-style work is continuous, often rapid connected breathing in a supported setting. NARA only offers a session timer and education — not an auto-pacer — because intensity varies widely and is normally facilitated.",
        ...
        BreathProtocol(
            ...
            edu: "Wim Hof–style rounds typically use ~30 deeper breaths, then an empty hold, then a recovery inhale hold (~15s). Because holds and intensity are personal, this entry is guided: follow a trusted protocol you already know; NARA times the session and shows reminders — it does not force breath holds.",
