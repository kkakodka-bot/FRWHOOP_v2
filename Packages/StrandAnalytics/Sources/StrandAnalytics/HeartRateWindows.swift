...
public enum HeartRateWindows {
    public static let version = "sampled-hr-five-minute-1"
    ...
    public static func windows(start: Int, end: Int, hr: [HRSample], gravity: [GravitySample],
        ...
        while t + 300 <= end {
            ...
            var movement = false, offBody = false
            ...
            let quietReason: String? = offBody ? "off_body_evidence" : movement ? "movement_detected" :
            ...
            output.append(Measurement(start: t, end: t + 300,
                ...
                reason: reason, lowMotionReason: quietReason))
            t += 300
        }
        return output
    }
