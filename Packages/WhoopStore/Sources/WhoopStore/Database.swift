...
extension WhoopStore {
    ...
    static func makeMigrator() -> DatabaseMigrator {
        ...
        // PR15/research builds already widened this key under v45-v26-record-index or
        // v46-ppg-record-identity. The cutover branch owns v46/v47, so append v48 and adopt
        // the existing lossless shape without rebuilding it or deleting indexed records.
