...
struct CaffeineLogCard: View {
    ...
    // when enabled, NARA works back from the user's bedtime by the dose's decay lead and flags any logged
    ...
    @ViewBuilder private var loggedList: some View {
        ...
        ForEach(store.intakes) { intake in
            HStack {
                ...
                // offering something NARA cannot honour. Remove it where it was logged.
