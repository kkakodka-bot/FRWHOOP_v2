        ...
        NoopCard(padding: 18, tint: StrandPalette.chargeColor) {
            VStack(alignment: .leading, spacing: NoopMetrics.cardInnerSpacing) {
                HStack {
                    ...
                    // The REAL source of the day's dashboard headline, not a hard-coded "NARA-computed".
                    // The By-Day numbers are always NARA's on-device scores, but when an import covers the
