...
// free-text — NEVER a NARA-shipped range. Blood pressure is a PAIRED marker (systolic +
...
// shown back verbatim — NARA defines no ranges and asserts no normality.
        ...
        VStack(alignment: .leading, spacing: NoopMetrics.gap) {
            ...
            NoopCard {
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    Text("NARA never fills this in. It only shows back exactly what you type from your own report.")
                        .font(StrandFont.footnote)
                        .foregroundStyle(StrandPalette.textTertiary)
