...
enum AppChangelog {
    ...
    static let releases: [Release] = [
        ...
        Release(
            version: "10.0.0",
            title: "Make NARA yours — theme colours and custom backgrounds, forty more sports with GPS routes, and a calorie heatmap",
            date: "August 2026",
            items: [
        ...
        Release(
            version: "7.2.0",
            title: "New: use an Apple Watch with NARA",
            date: "June 2026",
            items: [
        ...
        Release(
            ...
            items: [
                ...
                "**Storage clean-up that actually reclaims it.** A failed or retried Apple Health import could strand a multi-gigabyte unzipped copy that the Storage screen never saw, so it kept showing a huge footprint. NARA now recognises and sweeps those leftovers automatically on launch, and the Clean up button reclaims them too. Thanks @exzanimo (#590).",
        ...
        Release(
            version: "6.0.0",
            title: "NARA grows up: it's not just for WHOOP anymore",
            date: "June 2026",
            items: [
        ...
        Release(
            ...
            items: [
                ...
                "**New: a daily auto-export of your strap log (iPhone & Mac).** Turn it on under **Settings → Diagnostics**, pick a time, and NARA saves a timestamped copy once a day, so a log is waiting for a bug report without you remembering to grab it. Off by default, stays on your device. On Mac it runs while NARA is open; on iPhone it fires when iOS next wakes the app near your time, not to the exact minute. Android already had this. (#510)",
        ...
        Release(
            ...
            date: "June 2026",
            items: [
                "**Fixed: removing a WHOOP from Devices now actually releases it.** Before, NARA kept reconnecting to a removed strap and held it connected - so a 5/MG could never enter pairing mode, which blocked re-pairing a strap that got stuck. Remove now stops reconnecting, drops the link and frees the strap. (iPhone & Mac.) (#78)",
                "**Clearer help when a 5/MG won't bond.** If the strap keeps refusing the secure pairing, NARA now tells you exactly how to free and re-pair it (close the WHOOP app, pairing mode, forget in Bluetooth) rather than a misleading \"transient\" message. (#78)",
            ]),
        Release(
            version: "5.2.4",
        ...
        Release(
            ...
            date: "June 2026",
            items: [
                "**Fixed (WHOOP 5/MG): opening \"Add a WHOOP\" could drop a working strap and get stuck on \"connecting\".** If your 5/MG was connected and streaming, presenting the scan tore down the live connection - and the strap could then loop on \"connecting\" instead of re-bonding (with haptics going quiet). NARA now keeps a live same-family connection while it scans for nearby straps. (iPhone & Mac.) (#74)",
                "**Clearer guidance when a reconnect briefly hiccups.** If a strap NARA *just* bonded to momentarily refuses on a reconnect, it no longer wrongly tells you it's \"still paired to the WHOOP app\" - it recovers quietly instead. (#74)",
            ]),
        Release(
            version: "5.2.2",
        ...
        Release(
            ...
            items: [
                ...
                "**Smarter reconnect when your strap's out of range** - NARA backs off gradually instead of rescanning on a fixed timer (easier on battery), and reconnects instantly the moment you tap Connect. Thanks to **ryanbr** for the contribution. (Android - matches iPhone & Mac.)",
            ]),
        Release(
            version: "5.1.2",
        ...
        Release(
            version: "5.0.0",
            title: "v5 - the raw-signal release: NARA reads the signal, on your device, free",
            date: "June 2026",
            items: [
        ...
        Release(
            ...
            items: [
                ...
                "**Apple Health body composition** - NARA now reads your weight, body-fat %, lean mass and BMI from Apple Health on iPhone. (Thanks @h3ld3r - #20.)",
            ]),
        Release(
            version: "4.6.2",
        ...
        Release(
            ...
            items: [
                ...
                "**Trends report adds Workouts and Stress.** The exportable Trends report now leads with a **Workouts** row (your activity count over the range) and a **Stress** row (NARA's 0-3 daily autonomic-load trend), each with its own averages and a measured-vs-computed note, alongside recovery, sleep, HRV and the rest. (#457)",
        ...
        Release(
            ...
            date: "June 2026",
            items: [
                "**A gentle move reminder, if you want one.** Turn it on in Settings → Automations and NARA will buzz your strap after you've been sitting still too long (your threshold, default 45 min), within hours you choose (default 9-5), with a re-nudge cooldown you set. It's **off by default**, runs entirely from the motion already on your strap, and respects your quiet hours and only-when-worn settings. Thanks @cbarrado (#419).",
            ]),
        Release(
            version: "4.2.0",
        ...
        Release(
            ...
            items: [
                ...
                "**Generic heart-rate straps now actually connect.** A Polar / Wahoo / Coospo strap you made active was being *discovered* but never *connected to* - so it sat there with no live data. Fixed: NARA now connects straight to your selected strap. Thanks @pilleuspulcher-blip (#421).",
        ...
        Release(
            ...
            items: [
                ...
                "**Honest by design.** Every new number carries a ± band and a plain “this is a wellness estimate, not a clinical age” line. These build over a week or two of wear and sharpen as NARA learns your baseline.",
            ]),
        Release(
            version: "3.9.1",
        ...
        Release(
            ...
            items: [
                ...
                "**Honest Apple Health guidance on free sideloads:** if you installed NARA with a free Apple ID (AltStore / Sideloadly), the build can't be granted Apple Health access at all - so instead of pointing you to a Settings screen NARA can never appear in, it now tells you straight and routes you to the file-import / Shortcuts path. Properly-signed installs are unchanged. Thanks @exzanimo (#348).",
        ...
        Release(
            ...
            date: "June 2026",
            items: [
                "**New app icon (everywhere):** a bolder take on the Titanium & Gold mark - a thick **gold recovery ring + core** on deep navy, across iPhone, Mac and Android (and the in-app logo). Same NARA, sharper identity.",
        ...
        Release(
            ...
            items: [
                ...
                "Bluetooth & live HR: WHOOP 5/MG keeps decoding correctly after iOS relaunches NARA in the background, and the Lock-Screen / Dynamic-Island live heart rate now ends when the strap disconnects instead of freezing on a stale number. Thanks @vulnix0x4 (#378, #386).",
        ...
        Release(
            ...
            date: "June 2026",
            items: [
                "Fixed: a corrupt or mis-aligned Bluetooth frame could wedge the live data stream until you reconnected - NARA now spots an impossible frame length and resyncs to the next real frame instead of stalling. Thanks @vulnix0x4 (#374).",
                "Fixed (iPhone): the two-way Apple Health sync was reading its OWN written-back values back in as \"Apple Health\" data - which could make your strap and Apple Health plot the same line, and skew the Apple-Health average if you also wear a watch. It now excludes NARA's own samples on read, and a failed sync no longer reports a false \"success\". Thanks @vulnix0x4 (#375).",
            ]),
        Release(
            version: "3.0.1",
        ...
        Release(
            ...
            items: [
                ...
                "New (iPhone): **two-way Apple Health** you can actually turn on - enable it on the Apple Health screen and your NARA recovery, HRV, resting HR and more flow to Health (now including strap-only users), with the Apple Health screen finally populating. Thanks @vulnix0x4.",
        ...
        Release(
            ...
            date: "June 2026",
            items: [
                "New (Android): a **smart wake alarm** - set a wake window and NARA wakes you on a lighter sleep phase inside it, with a guaranteed alarm at the end of the window. The guaranteed wake is a real OS alarm that fires even if Bluetooth drops or the app is closed. Thanks @subscriptiondestroyer (#207).",
        ...
        Release(
            ...
            items: [
                ...
                "Improved: body vitals now show which source each reading came from (your WHOOP, NARA's own computation, or Apple Health) and merge them field-by-field instead of letting one source blank the others. Thanks @khalilkm01.",
                "New (Android): tap-and-drag to inspect the Stress chart, and a cleaner Explore metric picker. Thanks @ujix.",
                "New: an optional, read-only local access package (MCP) for power users who want to query their own on-device NARA data from local tools - opt-in, nothing leaves the device. Thanks @khalilkm01.",
        ...
        Release(
            ...
            items: [
                ...
                "New (Android): if NARA ever crashes, the details are now saved into the strap log you share - so a crash that only happens on your device can actually be diagnosed (#33).",
        ...
        Release(
            ...
            date: "June 2026",
            items: [
                "New (iPhone): a 'Using NARA on iPhone' note in Settings sets honest expectations - sideloading, re-signing, unlocking your phone after a reboot so history can sync - and shows how many days until your sideloaded build expires. The strap log you share now also carries the iPhone details (iOS version, lock state, background-refresh, low-power) that make iPhone-only issues quick to diagnose, with a one-tap Diagnostics screen to copy them.",
        ...
        Release(
            ...
            items: [
                ...
                "Fixed (iPhone): if a NARA backup from another platform had been restored (e.g. an Android backup onto an iPhone), the app could get permanently stuck on “store not ready” - the imported database held the data but not the bookkeeping NARA's database engine needs. NARA now recovers automatically on the next launch, and declines such a backup at import time with a clear explanation. To move history across platforms, use the WHOOP-format CSV export instead. Thanks @NoahMcE. (#222)",
            ]),
        Release(
            version: "2.8.4",
        ...
        Release(
            version: "2.6.0",
            title: "Charge, Effort & Rest - NARA's own scores, out of 100",
            date: "June 2026",
            items: [
        ...
        Release(
            version: "1.90",
            title: "NARA now tells you when your strap isn't saving history - and how to fix it",
            date: "June 2026",
            items: [
    ...
    static let expectations: [Expectation] = [
        Expectation(
            ...
            body: String(localized: "NARA is a personal, open project: not the WHOOP app, and not affiliated with WHOOP. It reads a strap you own, on your own device. Treat it as a capable work-in-progress rather than a finished product.")),
        Expectation(
            icon: "checkmark.seal",
            title: String(localized: "WHOOP 4.0 is the supported path"),
            body: String(localized: "WHOOP 4.0 is tested and works end to end. WHOOP 5.0/MG is newer: live heart rate works today, but deeper metrics (recovery, strain, sleep) for 5/MG are still being figured out. NARA always tells you what's live versus still building.")),
        Expectation(
            icon: "hourglass",
            title: String(localized: "Your scores build over a few nights"),
            body: String(localized: "Live heart rate is instant. Recovery, strain and sleep sharpen as NARA learns your baseline over your first nights of wear. Want your history now? Import your WHOOP export in Data Sources and it backfills in about a minute.")),
        Expectation(
            icon: "lock.shield",
            title: String(localized: "Everything stays on your device"),
            body: String(localized: "No account, no cloud, no sync. NARA talks only to your strap and keeps everything local. Your data is yours alone.")),
    ]
}
