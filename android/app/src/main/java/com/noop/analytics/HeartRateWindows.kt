...
object HeartRateWindows {
    const val VERSION = "sampled-hr-five-minute-1"
    data class Measurement(val start: Long, val end: Long, val meanBpm: Double?, val lowMotionBpm: Double?,
                           ...
                           val reason: String?, val lowMotionReason: String?)
    ...
    fun windows(start: Long, end: Long, hr: List<HrSample>, gravity: List<GravitySample>,
        ...
        while (t+300 <= end) {
            ...
            var movement=false; var offBody=false
            ...
            val quietReason=when { offBody -> "off_body_evidence"; movement -> "movement_detected"
