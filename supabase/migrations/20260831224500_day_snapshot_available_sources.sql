-- Overview was reading daily_metrics + sleep_details only. Sleep sessions,
-- energy_daily, basal_kcal, and Apple Watch step buckets already exist; expose
-- them on get_day_snapshot / get_range. Strap columns stay canonical when set.
...
as $$
  select coalesce(jsonb_agg(jsonb_build_object(
    ...
    'steps', coalesce(d.steps, watch.steps),
